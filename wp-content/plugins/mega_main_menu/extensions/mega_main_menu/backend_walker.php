 ...
 */
	 ...
	 * @return void
	 */
	add_action( 'wp_update_nav_menu_item', 'mmm_nav_update', 9999999999, 5 ); // 2014
	add_filter( 'wp_setup_nav_menu_item','mmm_nav_item', 9999999999, 5 );
	add_filter( 'wp_edit_nav_menu_walker', 'mega_main_menu_backend_walker', 9999999999, 5 );
...
*/
	...
	if ( !class_exists( 'Mega_Main_Menu_Backend_Walker' ) ) {
		...
		class Mega_Main_Menu_Backend_Walker extends Walker_Nav_Menu_Edit {
			/**
			...
			*/
			...
			/* Additional hook to allow other plugins add options. */
...
/*
			public function end_el( &$output, $item, $depth = 0, $args = array() ) {
				...
				$output .= '<div class="mmm_show_options_button"><div class="mmm_options_text">Show Mega Options</div></div>';
				$output .= "</li>{$n}";
			} // function end_el
*/

		} // class Mega_Main_Menu_Backend_Walker
	} // if !class_exists
