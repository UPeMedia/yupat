	...
	function mm_options_generator( $option, $mm_saved_value = false, $current_class = 'none' ){
		...
		switch ( $option['type'] ) {
			...
			case 'checkbox':
				...
				if ( is_array( $option['values'] ) ) {
					foreach ( $option['values'] as $key => $value ) {
						$out .= mm_common::ntab(10) . '<div class="mm_checkbox col-lg-' . $col_width . ' col-md-' . $col_width . ' col-sm-12 col-xs-12">';
			...
			case 'radio':
				...
				if ( is_array( $option['values'] ) ) {
					foreach ( $option['values'] as $key => $value ) {
						$out .= mm_common::ntab(10) . '<div class="mm_radio col-lg-' . $col_width . ' col-md-' . $col_width . ' col-sm-12 col-xs-12">';
			...
			case 'number':
				...
				if ( isset( $option['units'] ) && !empty( $option['units'] ) ) {
					$out .= mm_common::ntab(9) . '<div class="row">';
					$out .= mm_common::ntab(10) . '<div class="input-group input-group-sm col-lg-' . $col_width . ' col-md-' . $col_width . ' col-sm-12 col-xs-12">';
			...
			case 'file':
				...
				$out .= mm_common::ntab(9) . '<div class="row">';
				$out .= mm_common::ntab(10) . '<div class="input-group input-group-sm col-sm-9 col-xs-12">';
				...
				$out .= mm_common::ntab(12) . '<input class="' . $clear_full_key . ' select_file_button btn btn-primary" type="button" value="' . __( 'Select Image', 'mega_main' ) . '" />';
				$out .= mm_common::ntab(11) . '</span><!-- class="input-group-btn" -->';
				$out .= mm_common::ntab(10) . '</div><!-- class="input-group" -->';
				$out .= mm_common::ntab(10) . '<div class="col-sm-3 col-xs-12">';
			...
			case 'multiplier':
				...
				$out .= mm_common::ntab(9) . '<span class="btn btn-sm btn-primary multipler_add_one_more">' . __( 'Add One More', 'mega_main' ) . '</span>';
				break;
			case 'wpeditor':
...
//					'editor_class' => 'mm_must_be_wpeditor',
			...
			case 'animation':
				...
				$out .= mm_common::ntab(10) . '</div><!-- class="col-xs-9" -->';
				$out .= mm_common::ntab(10) . '<div class="col-xs-3">';
				$out .= mm_common::ntab(11) . '<div class="animation_preview">';
				$out .= mm_common::ntab(12) . '<span class="mme_animation animated ' . $animation . '">M</span>';
				$out .= mm_common::ntab(11) . '</div><!-- class="animation_preview" -->';
				$out .= mm_common::ntab(10) . '</div><!-- class="col-xs-3" -->';
				$out .= mm_common::ntab(9) . '</div><!-- class="row" -->';
				break;
			case 'caption':
				...
				break;
			case 'collapse_start':
				$out .= mm_common::ntab(5) . '<div class="panel bootstrap mm_clearfix ' . str_replace( array('[',']'), array('',''), $option['key'] ) . '">';
...
*/
			...
			case 'color':
				...
				$out .= mm_common::ntab(9) . '<div class="mm_must_be_colorpicker input-append color input-group input-group-sm col-md-' . $col_width . ' col-lg-' . $col_width . ' col-sm-12 col-xs-12" data-color="' . $value . '" data-color-format="rgba" id="' . $clear_full_key . '_colorpicker">';
			...
			case 'font':
				...
				if ( $option['values'] == '' || ( is_array( $option['values'] ) && in_array( 'font_color', $option['values'] ) ) ) {
					$out .= mm_common::ntab(8) . '<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-10 color">';
				...
				if ( $option['values'] == '' || ( is_array( $option['values'] ) && in_array( 'font_family', $option['values'] ) ) ) {
					$out .= mm_common::ntab(8) . '<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-10 family">';
					...
					$set_of_google_fonts[] = array( 'family' => 'serif' );
					$set_of_google_fonts[] = array( 'family' => 'sans-serif' );
					$set_of_google_fonts[] = array( 'family' => 'cursive' );
					$set_of_google_fonts[] = array( 'family' => 'fantasy' );
					$set_of_google_fonts[] = array( 'family' => 'monospace' );
					...
					$out .= mm_common::ntab(10) . '<optgroup label="' . __( 'Installed Google Fonts', 'mega_main' ). '">';
					foreach ( $set_of_google_fonts as $key => $value ) {
						if ( $value['family'] == 'Inherit' ) {
							$out .= mm_common::ntab(10) . '</optgroup>';
							$out .= mm_common::ntab(10) . '<optgroup label="' . __( 'Safe Web Fonts (Recommended)', 'mega_main' ). '">';
						}
				...
				if ( $option['values'] == '' || ( is_array( $option['values'] ) && in_array( 'font_size', $option['values'] ) ) ) {
					$out .= mm_common::ntab(8) . '<div class="input-group input-group-sm col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-10 size">';
				...
				if ( $option['values'] == '' || ( is_array( $option['values'] ) && in_array( 'font_weight', $option['values'] ) ) ) {
					$out .= mm_common::ntab(8) . '<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-10 weight">';
				...
				if ( $option['values'] == '' || ( is_array( $option['values'] ) && in_array( 'text_transform', $option['values'] ) ) ) {
					$out .= mm_common::ntab(8) . '<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-10 transform">';
					$out .= mm_common::ntab(9) . '<select class="col-xs-12 form-control input-sm" name="' . $option['key'] . '[text_transform]">';
					foreach ( array( 'none', 'uppercase', 'lowercase', 'capitalize' ) as $key => $value ) {
						$out .= mm_common::ntab(10) . '<option value="' . $value .'" ' . ( ( isset( $mm_saved_value['text_transform'] ) && $mm_saved_value['text_transform'] !== false ) 
							? ( $value == $mm_saved_value['text_transform'] 
								? 'selected="selected" ' 
								: ''
							)
							: ( ( isset( $option['default']['text_transform'] ) && $value == $option['default']['text_transform'] ) 
								? 'selected="selected" ' 
								: ''
							)
						) . '>' . ( is_string( $key ) ? $key : $value ) .'</option>';
					...
					$out .= mm_common::ntab(9) . '</select>';
					$out .= mm_common::ntab(8) . '</div><!-- class="col-lg-3 col-md-2 col-sm-6 col-xs-3 transform" -->';
				}
				$out .= mm_common::ntab(7) . '</div><!-- class="font_selector row" -->';
				break;
			case 'background_image':
				...
				$out .= mm_common::ntab(10) . '<div class="input-group input-group-sm col-sm-9 col-xs-12 mb-10">';
				...
				$out .= mm_common::ntab(11) . '</span><!-- class="input-group-btn" -->';
				$out .= mm_common::ntab(10) . '</div><!-- class="input-group" -->';
				$out .= mm_common::ntab(10) . '<div class="col-sm-3 col-xs-12 mb-10">';
				...
				$out .= mm_common::ntab(10) . '<div class="col-sm-3 col-xs-6 mb-10">';
				...
				$out .= mm_common::ntab(10) . '</div><!-- class="col-sm-3 col-xs-6" -->';
				$out .= mm_common::ntab(10) . '<div class="col-sm-3 col-xs-6 mb-10">';
				...
				foreach ( array( __( 'Keep original', 'mega_main' ) => 'auto', __( 'Stretch to width', 'mega_main' ) => '100% auto', __( 'Stretch to height', 'mega_main' ) => 'auto 100%','cover','contain') as $key => $value ) {
			...
			case 'gradient':
				...
				$out .= mm_common::ntab(10) . '<div class="col-sm-9 col-xs-12">';
				$out .= mm_common::ntab(11) . '<div class="row">';
				$out .= mm_common::ntab(12) . '<div class="col-xs-5 mb-10">';
				...
				$out .= mm_common::ntab(12) . '<div class="col-xs-2 mb-10 start_end">';
				$out .= mm_common::ntab(13) . __( 'Start', 'mega_main' );
				$out .= mm_common::ntab(12) . '</div><!-- class="col-xs-2" -->';
				$out .= mm_common::ntab(12) . '<div class="input-group input-group-sm col-xs-5 mb-10">';
				...
				$out .= mm_common::ntab(12) . '</div><!-- class="col-xs-5" -->';
				$out .= mm_common::ntab(12) . '<div class="col-xs-2 mb-10 start_end">';
				$out .= mm_common::ntab(13) . __( 'End', 'mega_main' );
				$out .= mm_common::ntab(12) . '</div><!-- class="col-xs-2" -->';
				$out .= mm_common::ntab(12) . '<div class="input-group input-group-sm col-xs-5 mb-10">';
				...
				$out .= mm_common::ntab(10) . '<div class="col-sm-3 col-xs-12">';
				$out .= mm_common::ntab(11) . '<div class="row">';
				$out .= mm_common::ntab(10) . '<div class="col-sm-12 col-xs-6 mb-10">';
				$out .= mm_common::ntab(11) . '<select class="col-xs-12 form-control input-sm" name="' . $option['key'] . '[orientation]">';
				foreach ( array( __( 'Vertical', 'mega_main' ) => 'top', __( 'Horizontal', 'mega_main' ) => 'left', __( 'Radial', 'mega_main' ) => 'radial') as $key => $value ) {
				...
				$out .= mm_common::ntab(10) . '</div><!-- class="col-sm-12 col-xs-6" -->';
				$out .= mm_common::ntab(10) . '<div class="col-sm-12 col-xs-6 mb-10">';
				$out .= mm_common::ntab(10) . '<div class="col-xs-12 gradient_example pull-left">';
				$out .= mm_common::ntab(11) . __( 'Click Here to View Result', 'mega_main' );
